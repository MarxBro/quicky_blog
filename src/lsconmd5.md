...
El programa que sigue, lo fui dejando en distintos lugares en el
 tiempo, y ha sido un poco abandonado.

Lo retomé hace poco, ya que se mezclaban versiones de archivos iguales en una de
 la carpetas donde trabajo, bla bla.

La idea es un _ls con esteroides_, que permita ver claramente los _hashs md5_ de
